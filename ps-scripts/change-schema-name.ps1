...
CREATE TABLE [$($schemaName)].[dbo.audios](
	[AudioID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.businessunits](
...
CREATE TABLE [$($schemaName)].[dbo.campaigncontents](
...
CREATE TABLE [$($schemaName)].[dbo.campaignpermissions](
...
CREATE TABLE [$($schemaName)].[dbo.campaigns](
	[CampaignID] [bigint] NULL,
	[IsDeleted] [bit] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.catries](
	[CatryID] [bigint] NULL,
	[IsDeleted] [bit] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.certifications](
...
CREATE TABLE [$($schemaName)].[dbo.componentactivities](
...
CREATE TABLE [$($schemaName)].[dbo.courseActivityViews](
...
CREATE TABLE [$($schemaName)].[dbo.coursecatries](
...
CREATE TABLE [$($schemaName)].[dbo.coursepermissions](
	[UserID] [bigint] NULL,
	[CourseID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.courses](
	[CourseID] [bigint] NULL,
	[ClientUniqueIdentifier] [nvarchar](max) NULL,
	[IsDeleted] [bit] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.coursetags](
	[TagID] [bigint] NULL,
	[CourseID] [bigint] NULL,
	[Page] [bigint] NULL,
	[PageSize] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.enrollables](
	[EnrollableID] [bigint] NULL,
	[ClientUniqueIdentifier] [nvarchar](max) NULL,
	[IsDeleted] [bit] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.enrollabletags](
	[TagID] [bigint] NULL,
	[EnrollableID] [bigint] NULL,
	[Page] [bigint] NULL,
	[PageSize] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.enrollments](
	[EnrollmentID] [bigint] NULL,
	[ClientUniqueIdentifier] [nvarchar](max) NULL,
	[IsDeleted] [bit] NULL,
	[IsBlocked] [bit] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.equivalencyrequests](
...
CREATE TABLE [$($schemaName)].[dbo.examquestions](
...
CREATE TABLE [$($schemaName)].[dbo.exams](
	[ExamID] [bigint] NULL,
	[IsDeleted] [bit] NULL,
	[Title] [nvarchar](max) NULL,
	[FullPath] [nvarchar](max) NULL,
...
CREATE TABLE [$($schemaName)].[dbo.examtaken](
...
CREATE TABLE [$($schemaName)].[dbo.examtakenquestions](
...
CREATE TABLE [$($schemaName)].[dbo.htmls](
...
CREATE TABLE [$($schemaName)].[dbo.labels](
	[LabelID] [bigint] NULL,
	[ClientUniqueIdentifier] [nvarchar](max) NULL,
...
CREATE TABLE [$($schemaName)].[dbo.medialibraryfiledownloads](
...
CREATE TABLE [$($schemaName)].[dbo.medialibraryhtmls](
...
CREATE TABLE [$($schemaName)].[dbo.medialibraryhtmlviews](
...
CREATE TABLE [$($schemaName)].[dbo.medialibrarypermissions](
...
CREATE TABLE [$($schemaName)].[dbo.medialibraryvideos](
	[MediaContentID] [bigint] NULL,
	[IsDeleted] [bit] NULL,
	[CatryID] [bigint] NULL,
	[Media_Name] [nvarchar](max) NULL,
...
CREATE TABLE [$($schemaName)].[dbo.occupationareas](
	[OccupationAreaID] [bigint] NULL,
	[ClientUniqueIdentifier] [nvarchar](max) NULL,
...
CREATE TABLE [$($schemaName)].[dbo.placerooms](
...
CREATE TABLE [$($schemaName)].[dbo.places](
	[PlaceID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.positions](
...
CREATE TABLE [$($schemaName)].[dbo.ppts](
...
CREATE TABLE [$($schemaName)].[dbo.presentialmeetings](
...
CREATE TABLE [$($schemaName)].[dbo.questions](
	[QuestionID] [bigint] NULL,
	[IsDeleted] [bit] NULL,
	[Title] [nvarchar](max) NULL,
...
CREATE TABLE [$($schemaName)].[dbo.scorms](
	[ScormID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.surveyanswerquestions](
...
CREATE TABLE [$($schemaName)].[dbo.surveyanswers](
	[SurveyAnswerID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.surveyquestionoptions](
	[SurveyQuestionOptionID] [bigint] NULL,
	[QuestionID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.surveyquestions](
	[SurveyQuestionID] [bigint] NULL,
	[Question] [nvarchar](max) NULL,
	[SurveyID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.surveys](
	[SurveyID] [bigint] NULL,
	[Title] [nvarchar](max) NULL,
	[IsDeleted] [bit] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.tags](
	[TagID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.uploadactivities](
	[FileAssignmentID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.useraccesshistorys](
	[UserID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.userbusinessunits](
...
CREATE TABLE [$($schemaName)].[dbo.usercertifications](
	[CertificationID] [bigint] NULL,
	[UserID] [bigint] NULL,
	[CourseID] [bigint] NULL,
...
CREATE TABLE [$($schemaName)].[dbo.userlabels](
...
CREATE TABLE [$($schemaName)].[dbo.users](
	[UserID] [bigint] NULL,
	[ClientUniqueIdentifier] [nvarchar](max) NULL,
...
CREATE TABLE [$($schemaName)].[dbo.videos](
	[VideoID] [float] NULL,
	[IsDeleted] [bit] NULL,
	[Title] [nvarchar](max) NULL,
	[FullPath] [nvarchar](max) NULL,
...
CREATE TABLE [$($schemaName)].[dbo.videoviews](
...
CREATE TABLE [$($schemaName)].[dbo.webmeeting](
...
CREATE TABLE [$($schemaName)].[teste_cursos](
	[CourseID] [bigint] NULL,
	[ClientUniqueIdentifier] [nvarchar](max) NULL,
	[IsDeleted] [bit] NULL,
	[CourseName] [nvarchar](max) NULL,
...
CREATE TABLE [$($schemaName)].[teste_positions](
	[PositionID] [bigint] NULL,
	[PositionName] [nvarchar](max) NULL,
	[IsDeleted] [bit] NULL,
	[AuditCreatedDate] [nvarchar](max) NULL,
...
Out-File -FilePath "$($workspace)\models\Create_Tables.sql" -InputObject $query