...
New-AzResourceGroupDeployment -ResourceGroupName $resourceGroupName -Name $trigger.BaseName -TemplateFile $trigger.FullName -Mode Incremental -dataFactoryName $dataFactoryName
