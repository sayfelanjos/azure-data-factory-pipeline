...
if ($isPresent) {
    ...
    New-AzResourceGroupDeployment -ResourceGroupName $resourceGroupName -TemplateFile $templatePath -serverName $serverName -dbName $dbName -sqlServerAdminLogin $adminLogin -sqlServerAdminPassword $adminPassword
}