...
var pipelineName = 'CopyComponentActivitiesDataWithAutoSetDatePipeline'
        ...
        inputs: [
          {
            ...
            parameters: {
              SetApiName: {
                value: 'componentactivities?page={pagina}&page_size=5000&update_start_date=@{variables(\'NextRunPipelineDate\')}'
                type: 'Expression'
              }
            }
          }
