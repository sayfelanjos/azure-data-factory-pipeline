...
var pipelineName = 'CopyPPTSDataWithAutoSetDatePipeline'
  ...
  properties: {
    activities: [
      ...
      }
      {
        ...
        inputs: [
          {
            referenceName: 'PPTSEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'ppts?page={pagina}&page_size=5000&update_start_date=@{variables(\'NextRunPipelineDate\')}'
                type: 'Expression'
              }
            }
          }
