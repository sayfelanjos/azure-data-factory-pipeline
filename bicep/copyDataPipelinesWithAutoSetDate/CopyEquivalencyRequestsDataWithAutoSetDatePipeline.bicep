...
var pipelineName = 'CopyEquivalencyRequestsDataWithAutoSetDatePipeline'
        ...
        inputs: [
          {
            ...
            parameters: {
              SetApiName: 'equivalencyrequests?page={pagina}&page_size=5000&update_start_date=@{variables(\'NextRunPipelineDate\')}'
              type: 'string'
            }
          }
        ]
