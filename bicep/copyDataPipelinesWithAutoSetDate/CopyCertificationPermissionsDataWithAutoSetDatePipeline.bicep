...
var pipelineName = 'CopyCertificationPermissionsDataWithAutoSetDatePipeline'
        ...
        inputs: [
          {
            ...
            parameters: {
              SetApiName: {
                value: 'certificationpermissions?page={pagina}&page_size=5000&update_start_date=@{variables(\'NextRunPipelineDate\')}'
                type: 'Expression'
              }
            }
          }
