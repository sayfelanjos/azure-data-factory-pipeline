...
var pipelineName = 'CopyExamTakensDataWithAutoSetDatePipeline'
        ...
        inputs: [
          {
            ...
            parameters: {
              SetApiName: 'examtakens?page={pagina}&page_size=5000&update_start_date=@{variables(\'NextRunPipelineDate\')}'
            }
          }
        ]
        outputs: [
