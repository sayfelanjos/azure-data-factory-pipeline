...
var pipelineName = 'CopyCourseTagsDataWithAutoSetDatePipeline'
        ...
        inputs: [
          {
            ...
            parameters: {
              SetApiName: 'coursetags?page={pagina}&page_size=5000&update_start_date=@{variables(\'NextRunPipelineDate\')}'
            }
          }
        ]
        outputs: [
