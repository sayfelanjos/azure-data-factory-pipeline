...
var pipelineName = 'CopySurveyAnswerQuestionsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            ...
            parameters: {
              SetApiName: {
                value: 'surveyanswersquestions?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
        ...
        outputs: [
          {
            referenceName: 'SurveyAnswerQuestionsTable'
            type: 'DatasetReference'
          }
        ]
      }
