...
var pipelineName = 'CopySurveyQuestionsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'SurveyQuestionsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'surveyquestions?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
        ...
        outputs: [
          {
            referenceName: 'SurveyQuestionsTable'
            type: 'DatasetReference'
          }
        ]
      }
