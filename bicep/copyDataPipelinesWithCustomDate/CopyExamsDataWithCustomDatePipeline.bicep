...
var pipelineName = 'CopyExamsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'ExamsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'exams?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
