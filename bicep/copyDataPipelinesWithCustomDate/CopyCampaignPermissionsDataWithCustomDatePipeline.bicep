...
var pipelineName = 'CopyCampaignPermissionsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'CampaignPermissionsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'campaignpermissions?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
        ...
        outputs: [
          {
            referenceName: 'CampaignPermissionsTable'
            type: 'DatasetReference'
          }
        ]
      }
