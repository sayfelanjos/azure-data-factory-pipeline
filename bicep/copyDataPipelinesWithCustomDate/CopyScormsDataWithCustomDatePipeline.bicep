...
var pipelineName = 'CopyScormsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'ScormsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'scorms?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
