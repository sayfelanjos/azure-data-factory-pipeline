...
var pipelineName = 'CopyExamQuestionsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'ExamQuestionsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'examquestions?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
        ...
        outputs: [
          {
            referenceName: 'ExamQuestionsTable'
            type: 'DatasetReference'
          }
        ]
      }
