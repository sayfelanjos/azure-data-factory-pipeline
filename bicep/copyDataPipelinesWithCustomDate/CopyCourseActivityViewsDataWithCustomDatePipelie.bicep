...
var pipelineName = 'CopyCourseActivityViewsDataWithCustomDatePipelie'
        ...
        inputs: [
          {
            ...
            parameters: {
              SetApiName: {
                value: 'courseActivityViews?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
