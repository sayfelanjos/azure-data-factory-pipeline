...
var pipelineName = 'CopyPresentialMeetingsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'PresentialMeetingsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'presentialmeetings?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
        ...
        outputs: [
          {
            referenceName: 'PresentialMeetingsTable'
            type: 'DatasetReference'
          }
        ]
      }
