...
var pipelineName = 'CopyEnrollmentsDataWithCustomDatePipeline'
        ...
        inputs: [
          {
            ...
            parameters: {
              SetApiName: 'enrollments?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
              type: 'Expression'
            }
          }
        ]
