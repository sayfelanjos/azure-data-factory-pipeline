...
var pipelineName = 'CopyEquivalencyRequestsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'EquivalencyRequestsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: 'equivalencyrequests?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
              type: 'string'
            }
          }
        ]
        outputs: [
          {
            referenceName: 'EquivalencyRequestsTable'
            type: 'DatasetReference'
          }
        ]
      }
