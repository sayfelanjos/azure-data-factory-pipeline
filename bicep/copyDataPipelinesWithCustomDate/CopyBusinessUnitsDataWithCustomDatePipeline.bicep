...
var pipelineName = 'CopyBusinessUnitsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'BusinessUnitsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'businessunits?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
        ...
        outputs: [
          {
            referenceName: 'BusinessUnitsTable'
            type: 'DatasetReference'
          }
        ]
      }
