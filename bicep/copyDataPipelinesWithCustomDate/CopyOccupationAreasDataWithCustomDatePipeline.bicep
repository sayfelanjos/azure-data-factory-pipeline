...
var pipelineName = 'CopyOccupationAreasDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'OccupationareasEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'occupationareas?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
        ...
        outputs: [
          {
            referenceName: 'OccupationAreasTable'
            type: 'DatasetReference'
          }
        ]
      }
