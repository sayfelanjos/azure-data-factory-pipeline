...
var pipelineName = 'CopyQuestionsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'QuestionsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'questions?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
