...
var pipelineName = 'CopyUserLabelsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'UserLabelsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'userlabels?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
