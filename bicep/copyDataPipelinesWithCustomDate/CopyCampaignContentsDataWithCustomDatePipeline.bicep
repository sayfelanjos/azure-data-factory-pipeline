...
var pipelineName = 'CopyCampaignContentsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'CampaignContentsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'campaigncontents?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
        ...
        outputs: [
          {
            referenceName: 'CampaignContentsTable'
            type: 'DatasetReference'
          }
        ]
      }
