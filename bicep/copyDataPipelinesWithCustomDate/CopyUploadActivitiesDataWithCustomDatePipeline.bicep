...
var pipelineName = 'CopyUploadActivitiesDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'UploadActivitiesEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'uploadactivities?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
        ...
        outputs: [
          {
            referenceName: 'UploadActivitiesTable'
            type: 'DatasetReference'
          }
        ]
      }
