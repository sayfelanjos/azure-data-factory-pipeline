...
var pipelineName = 'CopyUserBusinessUnitsDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'UserBusinessUnitsEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'userbusinessunits?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
        ...
        outputs: [
          {
            referenceName: 'UserBusinessUnitsTable'
            type: 'DatasetReference'
          }
        ]
      }
