...
var pipelineName = 'CopyAudiosDataWithCustomDatePipeline'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'AudiosEndPoint'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'audios?page={pagina}&page_size=5000&update_start_date=@{pipeline().globalParameters.NewRunPipelineDateGlobalVariable}'
                type: 'Expression'
              }
            }
          }
