...
resource dataFactorySqlDatabaseLinkedService 'Microsoft.DataFactory/factories/linkedservices@2018-06-01' = {
  ...
  properties: {
    ...
    typeProperties: {
      connectionString: 'Data Source=${sqlServer.properties.fullyQualifiedDomainName};Initial Catalog=${resourceGroupName}-sql-database;Integrated Security=False;User ID=${sqlServerUserName};'
      encryptedCredential: sqlServerPassword
    }
  }
}
