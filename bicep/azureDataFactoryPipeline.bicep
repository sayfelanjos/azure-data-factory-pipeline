...
var dataFactoryDataSetInName = '${resourceGroupName}-factory-data-source'
var dataFactoryDataSetOutName = '${resourceGroupName}-factory-data-destination'
var pipelineName = '${resourceGroupName}-factory -pipeline'
