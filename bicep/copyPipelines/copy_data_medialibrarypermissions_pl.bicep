...
var pipelineName = 'copy_data_medialibrarypermissions_pl'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'medialibrarypermissions_ep'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                type: 'Expression'
                value: 'medialibrarypermissions?page={pagina}&page_size=5000&update_start_date=2022-01-01'
              }
            }
          }
        ]
