...
var pipelineName = 'copy_data_uploadactivities_pl'
    ...
    activities: [
      {
        ...
        inputs: [
          {
            referenceName: 'uploadactivities_ep'
            type: 'DatasetReference'
            parameters: {
              SetApiName: {
                value: 'uploadactivities?page={pagina}&page_size=5000&update_start_date=${updateStartDate}'
                type: 'Expression'
              }
            }
          }
