...
resource courses_pl 'Microsoft.DataFactory/factories/pipelines@2018-06-01' = {
  name: pipelineName
  parent: dataFactory
  properties: {
    activities: [
      {
        name: 'Extract_Load - Cursos'
        type: 'ForEach'
        dependsOn: []
        userProperties: []
        typeProperties: {
          ...
          activities: [
            ...
            }
            {
              ...
              inputs: [
                {
                  ...
                  parameters: {
                    SetApiName: {
                      value: 'placerooms?page={pagina}&page_size=5000&update_start_date=2022-01-01'
                      type: 'Expression'
                    }
                  }
                }
              ...
              outputs: [
                {
                  referenceName: 'placerooms_tb'
                  type: 'DatasetReference'
                }
              ]
            }
            {
              name: 'Copy_data_Enrollments'
              description: ''
              type: 'Copy'
              dependsOn: []
              policy: {
              ...
              inputs: [
                {
                  ...
                  parameters: {
                    SetApiName: {
                      value: 'enrollments?page={pagina}&page_size=5000&maximumpagesize=5000&update_start_date=2022-01-01'
                      type: 'Expression'
                    }
                  }
                }
            ...
            {
              name: 'Copy_data_EquivalencyRequests'
              description: ''
              type: 'Copy'
              dependsOn: []
              policy: {
            ...
            }
            {
              ...
              inputs: [
                {
                  ...
                  parameters: {
                    SetApiName: {
                      value: 'places?page={pagina}&page_size=5000&update_start_date=2022-01-01'
                      type: 'Expression'
                    }
                  }
                }
              ...
              outputs: [
                {
                  referenceName: 'places_tb'
                  type: 'DatasetReference'
                }
              ]
            }
            {
              name: 'Copy_data_Enrollables'
              description: ''
              type: 'Copy'
              dependsOn: []
              policy: {
            ...
            {
              name: 'Copy_data_ComponentActivities'
              description: ''
              type: 'Copy'
              dependsOn: []
              policy: {
              ...
              inputs: [
                {
                  ...
                  parameters: {
                    SetApiName: {
                      value: 'componentactivities?page={pagina}&page_size=5000&maximumpagesize=5000&update_start_date=2022-01-01'
                      type: 'Expression'
                    }
                  }
                }
      ...
      {
        name: 'Extract_Load - Certificacoes'
        type: 'ForEach'
        dependsOn: [
          {
            activity: 'Extract_Load - Cursos'
        ...
        typeProperties: {
          ...
          activities: [
            ...
            {
              name: 'Copy_data_UserCertifications'
              description: ''
              type: 'Copy'
              dependsOn: []
              policy: {
              ...
              inputs: [
                {
                  ...
                  parameters: {
                    SetApiName: {
                      value: 'usercertifications?page={pagina}&page_size=5000&update_start_date=2022-01-01'
                      type: 'Expression'
                    }
                  }
                }
              ...
              outputs: [
                {
                  referenceName: 'usercertifications_tb'
                  type: 'DatasetReference'
                }
              ]
            }
