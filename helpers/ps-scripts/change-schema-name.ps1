$modelsPath = 'C:\Users\saymo\eng4tech\neolude\LAB-NEOLUDE-DATAOPS\models'
$tables = Get-Content 'C:\Users\saymo\eng4tech\neolude\LAB-NEOLUDE-DATAOPS\ps-scripts\end-points.txt'
$sqlQuery
...
# 		WHERE s.name='neolude' and t.name='$tableName'
# 	) 
...
# Out-File -FilePath $modelsPath -InputObject $query
